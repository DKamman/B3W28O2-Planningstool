...
--
-- Host: localhost
-- Gegenereerd op: 17 mei 2019 om 21:46
-- Serverversie: 5.6.37
-- PHP-versie: 7.1.8
...
--
CREATE DATABASE IF NOT EXISTS `planningtool` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `planningtool`;
...
INSERT INTO `games` (`id`, `name`, `image`, `description`, `expansions`, `skills`, `url`, `youtube`, `min_players`, `max_players`, `play_minutes`, `explain_minutes`, `new`) VALUES
...
INSERT INTO `planning` (`id`, `start_time`, `duration`, `presentor`, `player`, `game_id`) VALUES
(2, '04:15:00', 55, 'Giovanni Vermoen', 'Michael Khouw', 2),
(3, '16:30:00', 110, 'Giovanni Vermoen', 'Narison Clemencia', 12),
(10, '16:30:00', 60, 'Justin Kok', ' Narison Clemencia,  Michael Khouw,  Jeroen Kamman', 21);
...
(5, 'Michael', 'Khouw', 18, 1),
(6, 'Jeroen', 'Kamman', 27, 0),
(7, 'Rick', 'Caspers', 16, 0),
(8, 'Giovanni', 'Vermoen', 15, 1),
(9, 'Danny', 'Kamman', 22, 1),
(10, 'Justin', 'Kok', 18, 1);
